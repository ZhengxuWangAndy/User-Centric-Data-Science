...
if __name__ == '__main__':
    ...
    with tracer.start_as_current_span("main-start") as pivot:
        ...
        Info = pivot.get_span_context()
        Info_dict = {'trace_id': Info.trace_id,
                 'span_id': Info.span_id}

        with tracer.start_as_current_span("ClusterConfig"):
        ...
        with tracer.start_as_current_span("GoogleArchive"):
        ...
        with tracer.start_as_current_span("MockModel"):
            r_model = MockModel()
            with tracer.start_as_current_span("apply_model"):
